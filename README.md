...
<body>
    <div class="container">
        <div class="header">
            <h1>Gita amalia</h1>
            <p>Email:gitaamalia1609@gmail.com | No HP: 0895342276005 |  Onggopatran, Kebonagung, Imogiri ,Bantul,</p>
        </div>

        <div class="section">
            <h2>DATA PRIBADI</h2>
            <div class="item"><strong>Tempat, Tgl Lahir</strong>: Bantul, 16 September 2008</div>
        ...
        <div class="section">
            ...
            <ul>
                ...
                <li>Desain: Canva, Phortopolio</li>
